    ...
    <div class="form pt-4">
      ...
      <div class="line">
        <div class="inputfield">
          ...
          <input type="date" class="input" id="Date_debut" name="Date_debut" value="{{ old('Date_debut', isset($task) ? $task->Date_debut : '') }}" required>
        </div>
        <div class="inputfield">
          <label>Date d'échéance' :</label>
          <input type="date" class="input" id="Date_echeance" name="Date_echeance" value="{{ old('Date_echeance', isset($task) ? $task->Date_echeance : '') }}" required>
        </div>
      </div>
      <div class="line">
        <div class="inputfield">
